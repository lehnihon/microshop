	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12 text-left">
				<strong>Entrega, troca e devolução de produtos.</strong><br><br>
				<p>
					Este documento é parte integrante dos Termos e Condições de Uso do Site. 
					Caso haja conflito entre as disposições de ambos os documentos, deve prevalecer o que estiver estabelecido no mais específico.
				</p><br><br>
				<p>
...
Atendimento ao Cliente e seguir as instruções recebidas para que o pedido de troca seja analisado e processado.
				</p>
				<p>
					3.3. Caso identificado defeito técnico ou de fabricação, o prazo para solicitação de troca/devolução é de até 7 (sete) dias corridos, contando da data do 
recebimento do produto. Após esse período, o Cliente deverá encaminhar o produto à assistência técnica do fabricante.
				</p>
				<p>
					3.4. Caso haja a entrega de produtos diversos aos originalmente adquiridos, o consumidor deverá recusar a entrega ou solicitar troca do produto em até 7 (sete) 
...
contato com o Serviço de Atendimento ao Cliente para obter o passo a passo a ser seguido.
				...
				<p>
					3.6. Caso o produto a ser trocado não esteja mais disponível, o Cliente poderá optar pela:
				</p>
				<p>
				...
				<p>
					<strong>4.Arrependimento da compra (devolução):</strong>
				</p>
				<p>
					4.1. Caso o Cliente se arrependa de uma compra efetuada, poderá exercer seu direito ao manifestar seu interesse ao Serviço de Atendimento ao Cliente no prazo 
de 07 (sete) dias corridos a contar do recebimento do produto.
				</p>
				<p>
					4.2. O pedido de desistência passará por uma avaliação para verificar se houve utilização do produto ou sua destruição, ainda que parcial. Nestes casos, a 
devolução não será possível.
				</p>
				<p>
...
nosso Centro de Distribuição.
				...
				<p>
					5.2. Só será aceita a troca ou pedido de desistência do produto adquirido pelo Cliente que esteja:
				</p>
				<p>
					a) Perfeitamente acondicionado na embalagem original;
				</p>
				<p>
					b) Acompanhado do manual e todos os acessórios;
				</p>
				<p>
					c) Sem indícios de uso ou consumo;
				</p>
				<p>
...
solucionar a situação:
				...
				<p>
					a) Ausência do Cliente no local;
				</p>
				<p>
					b) Endereço incorreto;
				</p>
				<p>
					c) Descumprimento dos quesitos a, b, c e d do item 5.2.
				</p>
				<p>
					5.6. Caso não seja possível solucionar ocorrências situações descritas acima em até 05 (cinco) dias úteis, a solicitação de coleta do produto será cancelada.
				</p><br><br>
				<p>
					<strong>6. Atendimento ao cliente:</strong>
				</p>
				<p>
